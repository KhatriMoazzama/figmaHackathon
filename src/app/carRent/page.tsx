      ...
      <div className="sec w-full sm:w-[80%] bg-[#f6f7f9] p-4 sm:p-6  flex flex-col gap-10 font-[family-name:var(--font-geist-sans)]">
        ...
        <section className="popular w-full flex flex-col gap-4">
          <div className="sec grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { title: 'Koenigsegg', image: '/car (3).png', desc: 'Sport' },
              { title: 'Nissan GT - R', image: '/car.png', desc: 'Luxury' },
              { title: 'Rolls-Royce', image: '/car (1).png', desc: 'Sport' },
              { title: 'All New Rush', image: '/Car (2).png', desc: 'Luxury' },
              { title: 'CR - V', image: '/car (7).png', desc: 'Luxury' },
              { title: 'ALLNEW TERIOS', image: '/car (8).png', desc: 'SUV' },
              { title: 'MGZX Exclusive', image: '/car (9).png', desc: 'Luxury' },
              { title: 'NEW MGZS', image: '/car (10).png', desc: 'SUV' },
            ].map((car, index) => (
          ...
          {showMore && (
            <div className="sec grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                { title: 'MG ZX Exclusive', image: '/car (10).png', desc: 'SUV' },
                { title: 'NEW MG ZS', image: '/car (11).png', desc: 'Sedan' },
                { title: 'New MG ZX Excite', image: '/car (10).png', desc: 'Sport' },
                { title: 'NEW MG ZS', image: '/car (6).png', desc: 'Sedan' },
              ].map((car, index) => (
                <Card key={index} className="w-full max-w-[304px] mx-auto h-auto flex flex-col justify-between">
                  <CardHeader>
                    <CardTitle className="w-full flex items-center justify-between">
